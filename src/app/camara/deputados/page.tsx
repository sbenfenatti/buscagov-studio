    ...
    <div className="relative w-full min-h-screen overflow-auto">
      ...
      <main className="relative z-10 container mx-auto px-6 py-12 text-white">
        <div className="text-center">
            <h1 className="text-4xl font-bold">Lista de Deputados</h1>
            <p className="text-lg mt-4 text-gray-300">Em breve, a lista de todos os deputados será exibida aqui.</p>
        </div>
      </main>
    </div>
  );
